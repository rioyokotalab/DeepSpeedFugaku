...
#    /2ndfs/hp230254/u11887/dataset/llm-jp-corpus-v1.0.2/fugaku_13b/binarized/v2_2-code10k_en20k_ja30k
    /vol0503/data/hp230254/dataset/llm-jp-corpus-v1.0.2/fugaku_13b/binarized/v2_2-code10k_en20k_ja30k_rest80b
)
...
lr_decay_tokens_in_billion=0 #${train_token_in_billion}
...
train_samples=$(echo "${train_token_in_billion} * 1000 * 1000 * 1000 / ${SEQUENCE_LENGTH}" | bc)
