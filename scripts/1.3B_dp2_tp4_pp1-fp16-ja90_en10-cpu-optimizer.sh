...
# checkpoint
CHECKPOINT_PATH="/mnt/nfs/Users/kazuki/megatron-deepspeed/checkpoint/fugaku/1.3B-llm-jp-dataset-fp16-dp2-tp4-cpu-optimizer-tp4-ja90_en10"
...
mpirun -np $WORLD_SIZE -npernode $GPUS_PER_NODE \
  ...
  --wandb-name "1.3B-GPU-dp2-tp4-cpu-optimizer-ja90_en10-llm-jp-dataset-fp16"
