...
export INPUTDIR="/mnt/nfs/Users/tn/datasets/llm-jp-corpus/v1.0.2-merge/en_pile"

for i in {0..42} # Nは最後のファイル番号（例：19ならば0から19までの20ファイル）
do
    python /home/tn/DeepSpeedFugaku/tools/preprocess_data.py \
        --input $INPUTDIR/en_pile_merged_train_$i.jsonl \
        --output-prefix $OUTDIR/en_pile_merged_train_$i \
        --vocab-file $MODELDIR \
        --dataset-impl mmap \
